        ...
        <div className="card-deck mb-3">
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                You may have used for a long time now, but you may still have
                some issue's with some of the commands. A thorugh read should
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                served from a Node/express server and deploying it to the Heroku
                hosting platform.
              </p>
            </div>
            <div className="card-footer">
